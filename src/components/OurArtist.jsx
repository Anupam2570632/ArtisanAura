...
const OurArtist = () => {
    return (
        <div className='w-11/12 md:w-4/5 mx-auto text-center space-y-10 my-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 mx-auto gap-6'>
                <div className="card-main relative w-64 overflow-hidden mx-auto">
                    ...
                    <div className="card-item absolute h-[45%] text-center flex flex-col items-center justify-center gap-4 w-full bg-white  -bottom-56 font-bold text-black">
